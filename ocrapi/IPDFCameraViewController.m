...
{
    CIImage *overlay = [CIImage imageWithColor:[CIColor colorWithRed:0 green:0 blue:.9 alpha:0.4]];
    ...
    [self.stillImageOutput captureStillImageAsynchronouslyFromConnection:videoConnection completionHandler: ^(CMSampleBufferRef imageSampleBuffer, NSError *error)
     {
         ...
         _isCapturing = NO;
             ...
             [alert showWarning:self.window.rootViewController title:@"Error" subTitle:[error localizedDescription] closeButtonTitle:@"Dismiss" duration:0.0f];
         }
     }];
}
